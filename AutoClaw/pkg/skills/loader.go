...
type SkillsLoader struct {
	...
	globalSkills    string // 全局 skills (~/.autoclaw/skills)
...
func NewSkillsLoader(workspace string, globalSkills string, builtinSkills string) *SkillsLoader {
	return &SkillsLoader{
		...
		globalSkills:    globalSkills, // ~/.autoclaw/skills
...
func (sl *SkillsLoader) ListSkills() []SkillInfo {
	...
	// 全局 skills (~/.autoclaw/skills) - 被 workspace skills 覆盖
	if sl.globalSkills != "" {
...
func (sl *SkillsLoader) LoadSkill(name string) (string, bool) {
	...
	// 2. 其次从全局 skills 加载 (~/.autoclaw/skills)
	if sl.globalSkills != "" {
