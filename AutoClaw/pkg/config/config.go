...
type Config struct {
	...
	TasteKit  TasteKitConfig  `json:"tastekit"`
	Routing   RoutingConfig   `json:"routing"`
	mu        sync.RWMutex
}

// TasteKitConfig controls TasteKit integration.
...
// Empty bindings = single-agent mode (agent "default").
type RoutingConfig struct {
	Bindings []RoutingBinding `json:"bindings"`
	Agents   []AgentEntry     `json:"agents"`
}

// RoutingBinding maps channel+account context to an agent.
...
// AgentEntry defines a named agent in multi-agent mode.
